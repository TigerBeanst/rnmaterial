...
<html style="display:none" lang="zh">
  <head>
    ...
    <script>!
      function() {
        ...
        lsloader.clean = function() {
          try {
            for (var e = [], t = 0; t < localStorage.length; t++) e.push(localStorage.key(t));
            e.forEach(function(e) {
              var t = lsloader.getLS(e);
              t && -1 === t.indexOf(versionString) && lsloader.removeLS(e)
            })
          } catch(e) {}
        },
        lsloader.clean(),
        lsloader.load = function(e, t, s) {
          s = s ||
          function() {};
          var n;
          if ((n = this.getLS(e)) && -1 === n.indexOf(versionString)) return this.removeLS(e),
          void this.requestResource(e, t, s);
          if (n) {
            var a = n.split(versionString)[0];
            if (a != t) return console.log("reload:" + t),
            this.removeLS(e),
            void this.requestResource(e, t, s);
            n = n.split(versionString)[1],
            /\.js?.+$/.test(a) ? (this.jsRunSequence.push({
              name: e,
              code: n
            }), this.runjs(t, e, n)) : (document.getElementById(e).appendChild(document.createTextNode(n)), s())
          } else this.requestResource(e, t, s)
        },
        lsloader.requestResource = function(e, t, s) {
          var n = this;
          /\.js?.+$/.test(t) ? this.iojs(t, e,
          function(e, t, s) {
            n.setLS(t, e + versionString + s),
            n.runjs(e, t, s)
          }) : /\.css?.+$/.test(t) && this.iocss(t, e,
          function(s) {
            document.getElementById(e).appendChild(document.createTextNode(s)),
            n.setLS(e, t + versionString + s)
          },
          s)
        },
        lsloader.iojs = function(e, t, s) {
          var n = this;
          n.jsRunSequence.push({
            name: t,
            code: ""
          });
          try {
            ...
            a.onreadystatechange = function() {
              if (4 == a.readyState) {
                if ((a.status >= 200 && a.status < 300 || 304 == a.status) && "" != a.response) return void s(e, t, a.response);
                n.jsfallback(e, t)
              }
            },
            a.send(null)
        ...
        lsloader.iocss = function(e, t, s, n) {
          var a = this;
          try {
            ...
            u.onreadystatechange = function() {
              if (4 == u.readyState) {
                if ((u.status >= 200 && u.status < 300 || 304 == u.status) && "" != u.response) return s(u.response),
                void n();
                a.cssfallback(e, t, n)
              }
            },
        ...
        lsloader.iofonts = function(e, t, s, n) {
          var a = this;
          try {
            var u = new XMLHttpRequest;
            u.open("get", e, !0),
        ...
        lsloader.runjs = function(e, t, s) {
          if (t && s) for (var n in this.jsRunSequence) this.jsRunSequence[n].name == t && (this.jsRunSequence[n].code = s);
          if (this.jsRunSequence[0] && this.jsRunSequence[0].code && "failed" != this.jsRunSequence[0].status)(u = document.createElement("script")).appendChild(document.createTextNode(this.jsRunSequence[0].code)),
          u.type = "text/javascript",
          document.getElementsByTagName("head")[0].appendChild(u),
          this.jsRunSequence.shift(),
          this.jsRunSequence.length > 0 && this.runjs();
          else if (this.jsRunSequence[0] && "failed" == this.jsRunSequence[0].status) {
            var a = this,
            u = document.createElement("script");
            u.src = this.jsRunSequence[0].path,
            u.type = "text/javascript",
        ...
        lsloader.jsfallback = function(e, t) {
          if (!this.jsnamemap[t]) {
            this.jsnamemap[t] = t;
            for (var s in this.jsRunSequence) this.jsRunSequence[s].name == t && (this.jsRunSequence[s].code = "", this.jsRunSequence[s].status = "failed", this.jsRunSequence[s].path = e);
            this.runjs()
          }
        },
        lsloader.cssfallback = function(e, t, s) {
          if (!this.cssnamemap[t]) {
            this.cssnamemap[t] = 1;
        ...
        lsloader.runInlineScript = function(e, t) {
        ...
        lsloader.loadCombo = function(e) {
          var t = "",
          s = {};
          for (var n in e) {
            var a = this.getLS(e[n].name);
            if (a) var u = a.split(versionString)[0],
            i = a.split(versionString)[1];
            else u = "";
            u == e[n].path ? this.jsRunSequence.push({
              name: e[n].name,
              code: i,
              path: e[n].path
            }) : (this.jsRunSequence.push({
              ...
              path: e[n].path,
              status: "comboloading"
            }), s[e[n].name] = !0, t += ("" == t ? "": ";") + e[n].path)
          }
          var o = this;
          if (t) {
            var r = new XMLHttpRequest;
            r.open("get", combo + t, !0),
            r.onreadystatechange = function() {
              if (4 == r.readyState) if (r.status >= 200 && r.status < 300 || 304 == r.status) {
                if ("" != r.response) return void o.runCombo(r.response, s)
              } else {
                for (var e in o.jsRunSequence) s[o.jsRunSequence[e].name] && (o.jsRunSequence[e].status = "failed");
                o.runjs()
              }
            },
            r.send(null)
        ...
        lsloader.runCombo = function(e, t) { (e = e.split("/*combojs*/")).shift();
          for (var s in this.jsRunSequence) t[this.jsRunSequence[s].name] && e[0] && (this.jsRunSequence[s].status = "comboJS", this.jsRunSequence[s].code = e[0], this.setLS(this.jsRunSequence[s].name, this.jsRunSequence[s].path + versionString + e[0]), e.shift());
          this.runjs()
        }
      } ()</script>
    <style id="<?php echo bloginfo('template_url');?>/css/material.min.css"></style>
    <script>void 0 === window.lsLoadCSSMaxNums && (window.lsLoadCSSMaxNums = 0),
      window.lsLoadCSSMaxNums++,
      lsloader.load("<?php echo bloginfo('template_url');?>/css/material.min.css", "<?php echo bloginfo('template_url');?>/css/material.min.css",
      function() {
    ...
    <script>void 0 === window.lsLoadCSSMaxNums && (window.lsLoadCSSMaxNums = 0),
      window.lsLoadCSSMaxNums++,
      lsloader.load("<?php echo bloginfo('template_url');?>/css/style.min.css", "<?php echo bloginfo('template_url');?>/css/style.min.css",
      function() {
        void 0 === window.lsLoadCSSNums && (window.lsLoadCSSNums = 0),
        ++window.lsLoadCSSNums == window.lsLoadCSSMaxNums && (document.documentElement.style.display = "")
      })</script>
    ...
    <script>lsloader.load("<?php echo bloginfo('template_url');?>/js/jquery.min.js", "<?php echo bloginfo('template_url');?>/js/jquery.min.js")</script>
