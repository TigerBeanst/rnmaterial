...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'RnMaterial 主题设置', 'theme-textdomain' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置默认', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '点击确定进行重置。此操作不可撤回，一切设置将会还原默认！', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
